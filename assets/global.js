...
// $('#Search-In-Modal').keyup(function() {
...
$("#Search-In-Modal").on("change paste keyup focus", function() {
   var test1 = this.value;
  if(test1.length > 0) {    
  $.ajax({
	type: 'GET',
	url: '/collections/all?view=ch-all-product-search',
	dataType: 'html',
	success: function(data) { 
      // console.log(data);
      // console.log(test1);
      var markup =$(data).find('.main-wrapper').html();
      // console.log(markup);
      var value = test1.toLowerCase();
      var alax = "";
        ...
        $('#Huratips-Loop').html(alax);
      
       // $(markup).each(function( index ) {
       //   console.log();
       // if($(this).find('.product-heading').text().toLowerCase().indexOf(value) > -1){
       //    console.log($(this).find('.product-heading').text());  
       // }
       // })
      // $( ".product-heading" ).each(function( index ) {
